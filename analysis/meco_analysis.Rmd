...
plot_df %>%
  ...
  ggplot(aes(x = tag, y=m, color = theory)) +
    ...
    geom_text(aes(label = sig, color = theory), y = 0.095, size = 3, angle = 45) +
...
ggsave("./images/meco_results.pdf", device="pdf", width = 8, height = 4)
#ggsave("./images/agg_meco.pdf", device="pdf", width = 8, height = 4)
...
ggsave("./images/meco_coeffs.pdf", device = "pdf", width = 9 , height = 3.5)
