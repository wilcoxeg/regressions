...
```{r}
regression_forms = c(
  "regression ~ target_len + target_surp + dist",
  "regression ~ target_len + target_surp + dist + pmi",
  "regression ~ target_len + target_surp + dist + topk",
  "regression ~ target_len + target_surp + dist + kld",
  "regression ~ target_len + target_surp + dist + pmi + topk + kld"
)
