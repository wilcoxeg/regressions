...
load(file='/Users/ethan/Documents/professional/resources/regressions_resources/meco/joint_fix_trimmed.rda')
...
results_list <- list.files(path=results_path)
stats_df = do.call(rbind, lapply(results_list, function(x) read.csv(file=paste0(results_path, "/", x))))
